...
public class EnrolledOrganizationController {
  ...
  @ApiResponses(
      value = {
          @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EnrolledCreditorInstitutions.class))),
  ...
  public ResponseEntity<EnrolledCreditorInstitutions> getEnrolledOrganizations(
  ...
  public ResponseEntity<EnrolledCreditorInstitutionStations> getStationsForEnrolledOrganizations(
