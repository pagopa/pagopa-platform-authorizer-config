...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.authorizer.config.repository..*.*(..))")
  public void repository() {
    // all repository methods
  }

  @Pointcut("execution(* it.gov.pagopa.authorizer.config.service..*.*(..))")
  public void service() {
    // all service methods
  }

  @Pointcut("execution(* it.gov.pagopa.authorizer.config.exception.ErrorHandler.*(..))")
